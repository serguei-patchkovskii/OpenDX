...
{
    return (_dxf_ExCRCByteV (crc, (unsigned char *) &v, sizeof (unsigned char), 1));
}
...
{
    return (_dxf_ExCRCByteV (crc, (unsigned char*) v, 1, strlen(v)));
}
...
{
    return (_dxf_ExCRCByteV (crc, (unsigned char *) v, sizeof (EXCRC), n));
}
...
{
    return (_dxf_ExCRCByteV (crc, (unsigned char *) v, sizeof (long), n));
}
