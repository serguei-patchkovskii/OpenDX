 ...
 */
struct objlist {
    EDF_Id id;                  /* unique per input file */
...
struct dinfo {
    ...
    EDF_Id value;	/* system generated id for object aliases */
};
...
struct dict {
    ...
    EDF_Id nextid;                      /* unique system-allocated ids */
};
...
#define BADINDEX  ((struct dinfo *)NULL)
...
extern Error  _dxfnexttoken(struct finfo *f, int *class, int *subclass, EDF_Id *id);
extern Error  _dxfisnexttoken(struct finfo *f, int *class, int *subclass, EDF_Id *id);
...
extern Error  _dxfmatchsaysub(struct finfo *f, int class, int subclass, EDF_Id *id);
extern Error  _dxfmatchanysub(struct finfo *f, int class, int *subclass, EDF_Id *id);
extern Error  _dxfmatchnumber(struct finfo *f, int *subclass, Token *id);
extern Error  _dxfmatchid(struct finfo *f, int class, EDF_Id id, int noparse);
...
extern EDF_Id _dxfiskeyword(struct dict *d, char *word);
...
// GDA
extern EDF_Id _dxfputdict(struct dict *d, char *word);
extern EDF_Id _dxflookdict(struct dict *d, char *word);
extern char * _dxfdictname(struct dict *d, EDF_Id di);
extern Error  _dxfsetdictalias(struct dict *d, EDF_Id di, EDF_Id *value);
extern Error  _dxfgetdictinfo(struct dict *d, EDF_Id di, int *type, EDF_Id *value);
extern EDF_Id _dxfgetdictalias(struct dict *d, int alias);
// GDA

extern EDF_Id _dxfgetuniqueid(struct dict *d);
...
extern Error  _dxfaddobjlist(struct finfo *f, EDF_Id id, Object o, char *name, 
			     int start);
...
extern char * _dxfprtoken(struct tinfo *t, EDF_Id d);
...
Error _dxflook_objident(HashTable, Object, EDF_Id*, EDF_Id*);
Error _dxfinit_objident(HashTable *);
Error _dxfdelete_objident(HashTable);
Error _dxfadd_objident(HashTable, Object, EDF_Id, EDF_Id);
